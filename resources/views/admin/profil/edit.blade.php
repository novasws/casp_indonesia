                ...
                <div class="mb-4">
                    ...
                    @if($user->foto)
                        <div class="mt-3 flex items-center">
                            <input type="checkbox" id="hapus_foto" name="hapus_foto" value="1" class="w-4 h-4 text-rose-600 bg-slate-100 border-slate-300 rounded focus:ring-rose-500">
                            <label for="hapus_foto" class="ml-2 text-sm font-medium text-rose-600 cursor-pointer">Hapus foto profil saat ini (kembali ke inisial)</label>
                        </div>
                    @endif
                </div>

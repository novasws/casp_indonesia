...
<!-- Modal Detail -->
<div id="detailModal" class="fixed inset-0 z-[9999] hidden" style="width: 100vw; height: 100vh;">
    <!-- Backdrop yang fully cover segalanya -->
    <div class="absolute inset-0 bg-black/70 backdrop-blur-sm" onclick="closeDetailModal()" style="z-index: 9998;"></div>
    
    <!-- Modal content -->
    <div class="absolute inset-0 flex items-center justify-center p-4" style="z-index: 9999;">
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-5xl border border-slate-100 overflow-hidden transform transition-all" style="z-index: 10000;">
        {{-- Top accent bar --}}
